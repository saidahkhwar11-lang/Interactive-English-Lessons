...
(function(){
  ...
  .followup-rules{display:flex;gap:7px;flex-wrap:wrap;margin-top:5px}.followup-rules span{font-size:10.5px;color:#61777c;background:#f1f5f3;border:1px solid #dfe7e4;border-radius:999px;padding:4px 8px}.lesson-head-actions{display:flex;align-items:center;justify-content:flex-end}.pdf-report-btn{height:38px;padding:7px 14px!important;white-space:nowrap;background:#789b96!important;color:#fff!important;border-color:#789b96!important;font-weight:800!important}.upload-row{white-space:nowrap;padding:6px 10px!important;font-size:11.5px!important}

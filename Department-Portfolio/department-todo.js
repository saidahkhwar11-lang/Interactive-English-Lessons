...
window.renderTodoSummary=()=>{const e=document.getElementById('todoSummary');if(!e)return;const s=summary();e.innerHTML=s.overdue?`<b>${s.active}</b><span class="todo-overdue">${s.overdue}</span>`:`<b>${s.active}</b>`};
